...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basic: Schema.Attribute.Component<'information.title-description', false> &
      Schema.Attribute.Required &
    ...
    classDetails: Schema.Attribute.Component<
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dinamicZone: Schema.Attribute.DynamicZone<
      [
        'components-api.rich-text',
        'components-api.links-list',
        'components-api.image-gallery',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiStudyMaterialStudyMaterial
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['video', 'document', 'audio']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSubtomeSubtome extends Struct.CollectionTypeSchema {
  collectionName: 'subtomes';
  info: {
    displayName: 'subtome';
    pluralName: 'subtomes';
    singularName: 'subtome';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    teacherEmail: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    subtomes: Schema.Attribute.Relation<'oneToMany', 'api::subtome.subtome'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::subtome.subtome': ApiSubtomeSubtome;
